...
public class Reserva <T> {
    ...
    public static ArrayList<Reserva> JSONtoReserva(JSONArray arrayReservas) throws Exception
    {
        ...
        for(int m = 0; m<arrayReservas.length(); m++)
        {
            ...
            String reserva = objectReservas.getString("reserva"); ///A CORREGIR
            ...
            Reserva<String> reserva1 = new Reserva<>(reserva, numeroDeReserva, fechaDeRealizacion, fechaDeLlegada, fechaDeSalida, cantMenoresDeEdad, cantMayoresDeEdad);
