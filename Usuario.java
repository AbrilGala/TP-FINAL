...
public class Usuario extends Persona {
    ...
    /*public LogIn.Usuario(LogIn.Persona persona, String nombreUsuario, String contrasena)
    {
    ...
    public Usuario(Persona persona, String nombreUsuario, String contrasena, ArrayList reservas, ArrayList reservasCanceladas) {
        super(persona.getNombre(), persona.getApellido(), persona.getDni(), persona.getDireccion(), persona.getMail(), persona.getFechaDeNacimiento(), persona.getSexo());
        this.nombreUsuario = nombreUsuario;
        this.contrasena = contrasena;
    ...
    public boolean eliminarReserva(Reserva reserva)
    {
        ...
        eliminado = reservas.remove(reserva);
        eliminado = reservasCanceladas.add(reserva);
        return true;
    }

    public String MostrarUsuario() {
        String info = "";
        info += "Nombre de usuario: "+nombreUsuario+"\nEmpresa.Reserva: "+reservas.toString()+"\nReservas canceladas: "+reservasCanceladas.toString();
    ...
    public String mostrarListaReservasCanceladas()
    {
        String info="";
        for (Reserva aux:reservasCanceladas) {
            info+= aux.toString()+"\n";
        }
        return info;
    }
    public Reserva buscarReservasPorId(int id)
    {
